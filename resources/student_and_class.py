...
class Student_And_Class(Resource):
    ...
    def post(self):
        ...
        row = Student_And_ClassModel(
            class_id=data["class_id"], user_id=data["user_id"]
        )
    ...
    def get(self, class_id=None, page=None, per_page=None):
        ...
        if class_id is None:
            ...
            return {
                "list": list,
                "count": len(Student_And_ClassModel.query.all())
            }, 200
    ...
    def put(self, class_id, user_id):
        ...
        if row is None:
            ...
            if datetime.datetime.now() > exam_date:
...
class XemLichThi(Resource):
    ...
    def get(cls, user_id):
        ...
        list_exam = []
        if (
            UserModel.find_by_user_id(g.user.user_id).job == 2 or
            ...
            for row in list:
                ...
                for subject in list_subject:
                    exam = ExamModel.find_by_subject_id(
