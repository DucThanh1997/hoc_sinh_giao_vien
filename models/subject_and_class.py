...
class Subject_And_ClassModel(db.Model):
    ...
    subject_id = db.Column(db.String(80), db.ForeignKey("subject.subject_id"), nullable=False)
    ...
    def json(self):
        return {"class_id": self.class_id, "subject_id": self.subject_id, "exam_date": self.exam_date}
