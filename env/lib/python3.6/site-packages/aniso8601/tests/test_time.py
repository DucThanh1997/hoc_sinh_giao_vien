...
class TestTimeParserFunctions(unittest.TestCase):
    ...
    def test_parse_time(self):
        testtuples = (
            ...
            ("01:23.4567", {"hh": "01", "mm": "23.4567", "tz": None}),
    ...
    def test_split_tz(self):
        ...
        self.assertEqual(
            _split_tz("23:21:28.512400+00:00"), ("23:21:28.512400", "+00:00")
        )
        ...
        self.assertEqual(
            _split_tz("23:21:28.512400+11:15"), ("23:21:28.512400", "+11:15")
        )

        self.assertEqual(
            _split_tz("23:21:28.512400-12:34"), ("23:21:28.512400", "-12:34")
        )
