...
class Pbkdf2Test(TestCase):
    ...
    pbkdf2_test_vectors = [
        ...
        # from rfc 6070
        #
        (hb("0c60c80f961f0e71f3a9b524af6012062fe037a6"), b"password", b"salt", 1, 20),
        (hb("ea6c014dc72d6f8ccd1ed92ace1d41f0d8de8957"), b"password", b"salt", 2, 20),
        (
        ...
        (hb("56fa6aa75548099dcc37d7f03425e0c3"), b"pass\00word", b"sa\00lt", 4096, 16),
        #
        ...
        # custom tests
        #
        (hb("e248fb6b13365146f8ac6307cc222812"), b"secret", b"salt", 10, 16, "sha1"),
        (
