...
"""
    ...
    sample_config_5pd.update(
        deprecated=["des_crypt"], admin__context__deprecated=["des_crypt", "bsdi_crypt"]
    )

    sample_config_5pid = sample_config_1pid.copy()
    sample_config_5pid.update(
        {"deprecated": "des_crypt", "admin.context.deprecated": "des_crypt, bsdi_crypt"}
    )
    ...
    def test_04_from_sources(self):
        ...
        policy = CryptPolicy.from_sources(
            [self.sample_config_1s_path, self.sample_config_2s, self.sample_config_3pd]
        )
    ...
    def test_06_forbidden(self):
        ...
        self.assertRaises(
            KeyError, CryptPolicy, schemes=["des_crypt"], des_crypt__salt="xx"
        )
